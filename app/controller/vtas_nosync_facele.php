<?php
	...
	try {
		...
		switch ($opcion) {
			case 'biventasNoSync':
				$sql = "SELECT cli.codigo AS CODIGO, COALESCE(LTRIM(RTRIM(cli.rif)), 's I n - - - r E g I s t r A r') AS RIF,
						...
						FROM
							...
							LEFT JOIN FAC_ELE.dbo.ESClientes AS cli ON cli.codigo = nos.CODCLTE
