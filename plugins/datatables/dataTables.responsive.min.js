    ...
    a.extend(m.prototype, {
        ...
        _columnsVisiblity: function(b) {
            ...
            for (e = c.length; h < e; h++)
                if (!c[h].control && !c[h].never && !1 === l[h]) { f = !0; break } h = 0;
        ...
        _classLogic: function() {
            ...
            e.each(function(b, c) {
                for (var e = b.className.split(" "), f = !1, h = 0, l = e.length; h < l; h++) {
                    ...
                    if ("control" === k) { f = !0;
                        b.control = !0; return } a.each(d, function(b, a) {
                        b = a.name.split("-");
        ...
        _resize: function(b) {
            ...
            for (h = f.length - 1; 0 <= h; h--)
                if (e <= f[h].width) { g = f[h].name; break } var m = this._columnsVisiblity(g);
            this.s.current = m;
            f = !1;
            h = 0;
            for (e = r.length; h < e; h++)
                if (!1 === m[h] && !r[h].never && !r[h].control && !1 === !c.column(h).visible()) { f = !0; break } a(c.table().node()).toggleClass("collapsed", f);
            var p = !1,
                q = 0;
