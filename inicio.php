...
<html>
	...
	<body class="hold-transition sidebar-mini sidebar-collapse"
		...
		<div class="fixed-top main-header navbar navbar-expand border-bottom navbar-dark bg-dark elevation-2">
			...
			<div id="btncambiar" -warning" style="display: none;" onclick="actualizar('*', 'Todas las Tiendas')">
				...
				<div class="sidebar scroller m-0 p-0" style="overflow-x: hidden;">
					...
					<nav class="mb-3">
						<ul class="nav nav-pills nav-sidebar flex-column txtcomp" data-widget="treeview" role="menu" data-accordion="false">
							<?php if(strpos($_SESSION['modulos'], '[1]')!==false) { ?>
								<li class="nav-item">
									<div id="dashboard" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[2]')!==false) { ?>
								<li class="nav-item">
									<div id="est_clientes" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[17]')!==false) { ?>
								<li class="nav-item">
									<div id="vtas_articulos" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[18]')!==false) { ?>
								<li class="nav-item">
									<div id="calendario_vtas" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[3]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="vtas_sucursales" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[4]')!==false) { ?>
											<li class="nav-item">
												<div id="dia_ventas" class="nav-link menu" onclick="cargarcontenido(this.id); ">
										...
										<?php if(strpos($_SESSION['modulos'], '[5]')!==false) { ?>
											<li class="nav-item">
												<div id="sem_ventas" class="nav-link menu" onclick="cargarcontenido(this.id); ">
										...
										<?php if(strpos($_SESSION['modulos'], '[6]')!==false) { ?>
											<li class="nav-item">
												<div id="mes_ventas" class="nav-link menu" onclick="cargarcontenido(this.id); ">
							...
							<?php if(strpos($_SESSION['modulos'], '[8]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="vtas_departamentos" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[8]')!==false) { ?>
											<li class="nav-item">
												<div id="dia_ventas_dpto" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="fas fa-calendar-day nav-icon"></i>
													<p>Día X por Semana</p>
												</div>
											</li>
										...
										<?php if(strpos($_SESSION['modulos'], '[9]')!==false) { ?>
											<li class="nav-item">
												<div id="sem_ventas_dpto" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="fas fa-calendar-week nav-icon"></i>
													<p>4 Semanas</p>
												</div>
											</li>
										...
										<?php if(strpos($_SESSION['modulos'], '[10]')!==false) { ?>
											<li class="nav-item">
												<div id="mes_ventas_dpto" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="fas fa-calendar-alt nav-icon"></i>
													<p>4 Meses</p>
												</div>
											</li>
							...
							<?php if(strpos($_SESSION['modulos'], '[11]')!==false) { ?>
								<li class="nav-item has-treeview">
									<div id="vtas_promociones" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[11]')!==false) { ?>
											<li class="nav-item">
												<div id="dia_ventas_promo" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="fas fa-calendar-day nav-icon"></i>
													<p>Día X por Semana</p>
												</div>
											</li>
							...
							<?php if(strpos($_SESSION['modulos'], '[12]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="reportes_varios" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[12]')!==false) { ?>
											<li class="nav-item">
												<div id="reporte" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642;	<i class="nav-icon fas fa-print"></i>
										...
										<?php if(strpos($_SESSION['modulos'], '[32]')!==false) { ?>
											<li class="nav-item">
												<div id="exportvtasbimas" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[31]')!==false) { ?>
											<li class="nav-item">
												<div id="pedidos_vs_despachos" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[34]')!==false) { ?>
											<li class="nav-item">
												<div id="reporteDIAN" class="nav-link menu" onclick="cargarReporteDian()">
										...
										<?php if(strpos($_SESSION['modulos'], '[35]')!==false) { ?>
											<li class="nav-item">
												<div id="reporteDANE" class="nav-link menu" onclick="cargarReporteDane()">
										...
										<?php if(strpos($_SESSION['modulos'], '[36]')!==false) { ?>
											<li class="nav-item">
												<div id="exportacionesDIAN" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-file-csv"></i>
										...
										<?php if(strpos($_SESSION['modulos'], '[51]')!==false) { ?>
											<li class="nav-item">
												<div id="lista_precios_bimas" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[54]')!==false) { ?>
											<li class="nav-item">
												<div id="reporteNIELSEN" class="nav-link menu" onclick="cargarReporteNielsen()">
													&#9642; <i class="nav-icon fas fa-file-excel"></i>
													<p>Reporte NIELSEN</p>
												</div>
											</li>
										<?php } ?>
										<?php if(strpos($_SESSION['modulos'], '[59]')!==false) { ?>
											<li class="nav-item">
												<div id="guia_carnicos" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[13]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="mgraficos" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[13]')!==false) { ?>
											<li class="nav-item">
												<div id="cont_clientes" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[14]')!==false) { ?>
											<li class="nav-item">
												<div id="graf_vtasacum" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[15]')!==false) { ?>
											<li class="nav-item">
												<div id="graf_top20prod" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[20]')!==false) { ?>
											<li class="nav-item">
												<div id="graf_top20tipos" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[22]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="logistica" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[27]')!==false) { ?>
											<li class="nav-item">
												<div id="transacciones" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[38]')!==false) { ?>
											<li class="nav-item">
												<div id="recepciones" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[28]')!==false) { ?>
											<li class="nav-item">
												<div id="transp_transf" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[22]')!==false) { ?>
											<li class="nav-item">
												<div id="consulta_inv" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[55]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="cltes_admon" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[55]')!==false || $_SESSION['usuario']=='cramirez') { ?>
											<li class="nav-item">
												<div id="registro_clientes" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[56]')!==false || $_SESSION['usuario']=='cramirez') { ?>
											<li class="nav-item">
												<div id="vtas_nosync_facele" class="nav-link menu"
										...
										<?php if(strpos($_SESSION['modulos'], '[56]')!==false || $_SESSION['usuario']=='cramirez') { ?>
											<li class="nav-item">
												<div id="resumen_fac_ele" class="nav-link menu"
							...
							<?php if(strpos($_SESSION['modulos'], '[23]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="mconfiguracion" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[23]')!==false) { ?>
											<li class="nav-item">
												<div id="aud_costos" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[24]')!==false) { ?>
											<li class="nav-item">
												<div id="compara_vtas" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[25]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="msolicitudes" class="nav-link menu">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[25]')!==false) { ?>
											<li class="nav-item">
												<div id="consulta_inv_pedidos" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-file-alt"></i>
										...
										<?php if(strpos($_SESSION['modulos'], '[26]')!==false) { ?>
											<li class="nav-item">
												<div id="consulta_lista_pedidos" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[29]')!==false) { ?>
											<li class="nav-item">
												<div id="monitor_pedidos" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[41]')!==false ||
									 ...
									 strpos($_SESSION['modulos'], '[53]')!==false ||
									 strpos($_SESSION['modulos'], '[58]')!==false) { ?>
								<li class="nav-item has-treeview">
									<div id="msolicitudes" class="nav-link menu">
										<i class="nav-icon fas fa-carrot"></i>
										<p>Perecederos<i class="right fas fa-angle-left"></i></p>
									</div>
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[41]')!==false) { ?>
											<li class="nav-item">
												<div id="perecederos_pedidos" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[42]')!==false) { ?>
											<li class="nav-item">
												<div id="perecederos_consolida" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[46]')!==false) { ?>
											<li class="nav-item">
												<div id="perecederos_gdc" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-clipboard-list"></i>
										...
										<?php if(strpos($_SESSION['modulos'], '[47]')!==false) { ?>
											<li class="nav-item">
												<div id="perecederos_hdt" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-file-alt"></i>
										...
										<?php if(strpos($_SESSION['modulos'], '[48]')!==false) { ?>
											<li class="nav-item">
												<div id="perecederos_xbuy" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[50]')!==false) { ?>
											<li class="nav-item">
												<div id="perecederos_monitor" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-boxes"></i>
										...
										<?php if(strpos($_SESSION['modulos'], '[53]')!==false) { ?>
											<li class="nav-item">
												<div id="perecederos_resumen" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-not-equal"></i>
													<p>Resumen Perecederos</p>
												</div>
											</li>
										<?php } ?>
										<?php if(strpos($_SESSION['modulos'], '[58]')!==false) { ?>
											<li class="nav-item">
												<div id="sincro_costos" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-sitemap"></i>
													<p>Sinc. Costos a Tiendas</p>
												</div>
											</li>
										<?php } ?>
									</ul>
								...
								<li class="nav-item has-treeview">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[37]')!==false) { ?>
											<li class="nav-item">
												<div id="imagenes_web" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[39]')!==false ||
								...
								<li class="nav-item has-treeview">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[39]')!==false) { ?>
											<li class="nav-item">
												<div id="conf_bonos_pos" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-upload"></i>
										...
										<?php if(strpos($_SESSION['modulos'], '[44]')!==false) { ?>
											<li class="nav-item">
												<div id="reportes_pma" class="nav-link menu" onclick="cargarReportePMA();">
													&#9642; <i class="nav-icon fas fa-file-excel"></i>
													<p>Reportes PMA</p>
												</div>
											</li>
										...
										<?php if(strpos($_SESSION['modulos'], '[45]')!==false) { ?>
											<li class="nav-item">
												<div id="modificar_redimido" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[49]')!==false) { ?>
											<li class="nav-item">
												<div id="facturas2PDFong" class="nav-link menu" onclick="facturas2PDFong();">
										...
										<?php if(strpos($_SESSION['modulos'], '[52]')!==false) { ?>
											<li class="nav-item">
												<div id="movimientos_bonos" class="nav-link menu" onclick="cargarcontenido(this.id);">
							...
							<?php if(strpos($_SESSION['modulos'], '[39]')!==false ||
								...
								<li class="nav-item has-treeview">
									<div id="mconfiguracion" class="nav-link menu">
										...
										<p>Puntos Montes <i class="right fas fa-angle-left"></i></p>
									</div>
									<ul class="nav nav-treeview">
										<?php if($_SESSION['usuario']=='cramirez') { ?>
											<li class="nav-item">
												<div id="conf_puntos" class="nav-link menu" onclick="cargarcontenido(this.id);">
													&#9642; <i class="nav-icon fas fa-ellipsis-v"></i>
													<p>Configuración de Puntos</p>
												</div>
											</li>
										<?php } ?>
									</ul>
							...
							<?php if(strpos($_SESSION['modulos'], '[7]' )!==false ||
								...
								<li class="nav-item has-treeview">
									...
									<ul class="nav nav-treeview">
										<?php if(strpos($_SESSION['modulos'], '[7]')!==false) { ?>
											<li class="nav-item">
												<div id="usuarios" class="nav-link menu" onclick="cargarcontenido(this.id);">
										...
										<?php if(strpos($_SESSION['modulos'], '[16]')!==false) { ?>
											<li class="nav-item">
												<div id="subir_archivo" class="nav-link menu" onclick="lstArchivos();">
													&#9642;	<i class="nav-icon fas fa-upload"></i>
										...
										<?php if(strpos($_SESSION['modulos'], '[19]')!==false) { ?>
											<li class="nav-item">
												<div id="conf_dptos" class="nav-link menu" onclick="confDptos();">
										...
										<?php if(strpos($_SESSION['modulos'], '[21]')!==false) { ?>
											<li class="nav-item">
												<div id="tasa_dolar" class="nav-link menu" onclick="confTasas();">
										...
										<?php if(strpos($_SESSION['modulos'], '[43]')!==false) { ?>
											<li class="nav-item">
												<div id="articulos_proveedor" class="nav-link menu" onclick="cargarcontenido(this.id);">
		...
		<!-- JS propias app -->
		<script src="app/js/app.js?<?php echo rand();?>"></script>
		<!-- Encrypt js -->
